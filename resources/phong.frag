...
void main(){
	...
	// vec4 diffuse = texColor * dot(lightDir, vNormalW) * Kd;
    ...
    //FragColor = FragColor * 0.0001 + vec4(vec3(0.5, 0.5, 0.5) + vNormalW * 0.5, 1.0);
    //FragColor = FragColor * 0.0001 + vec4(vVertexPositionW, 1.0);
    FragColor = texColor;
}